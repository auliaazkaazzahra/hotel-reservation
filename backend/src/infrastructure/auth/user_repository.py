...
class UserRepository:
    ...
    def _initialize_default_users(self):
        ...
        # User: admin / admin123
        self.create_user(
            username="admin", email="admin@hotel.com", full_name="Hotel Administrator", password="admin123"
        )

        # User: user / user123
        self.create_user(username="user", email="user@hotel.com", full_name="Regular User", password="user123")
