...
from ..value_objects.value_objects import BookingStatus, CustomerID, PaymentID, StayPeriod, TotalAmount
...
class Reservation:
    ...
    def calculate_total_amount(self) -> None:
        ...
        total = sum(detail.calculate_subtotal(number_of_nights) for detail in self.reservation_details)
